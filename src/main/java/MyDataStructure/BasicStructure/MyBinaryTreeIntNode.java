 ...
 */
public class MyBinaryTreeIntNode {
    public BinNode root;
    public int size;
...
//        myTree.postOrderIter(myTree.root);  //迭代版
    ...
    public static void main(String[] args) {
        ...
        MyBinaryTreeIntNode myLevelTree1 = new MyBinaryTreeIntNode();
        myLevelTree1.testInitFromLevel(arr1);

        //通过 先序+中序 遍历数组构造二叉树
        int[] arrPre2 = new int[]{1, 2, 4, 5, 3, 6, 7};
        int[] arrIn2 = new int[]{4, 2, 5, 1, 6, 3, 7};
        MyBinaryTreeIntNode myPreInTree2 = new MyBinaryTreeIntNode();
        ...
        MyBinaryTreeIntNode myPreInTree3 = new MyBinaryTreeIntNode();
        ...
        //通过自定义节点构造二叉树
        MyBinaryTreeIntNode myNodeTree4 = new MyBinaryTreeIntNode();
        MyBinaryTreeIntNode.BinNode f = myNodeTree4.new BinNode(1112);
        MyBinaryTreeIntNode.BinNode e = myNodeTree4.new BinNode(122);
        MyBinaryTreeIntNode.BinNode d = myNodeTree4.new BinNode(111, null, f);
        MyBinaryTreeIntNode.BinNode c = myNodeTree4.new BinNode(12, null, e);
