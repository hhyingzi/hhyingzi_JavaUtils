...
public class MyTicketSalerWithIterator {
    public static void main(String[] args){
        ...
        for(String item : bus) System.out.println(item + "，请买车票!");
        System.out.println();
        ...
        while (conductorDesc.hasPrevious()) System.out.println(conductorDesc.previous() + "，请买车票!");
    }
}
